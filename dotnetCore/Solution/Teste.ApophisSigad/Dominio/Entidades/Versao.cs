...
namespace Teste.ApophisSigad.Dominio.Entidades
{
    /// <summary>
    /// Entidade: Versão
    /// Representa no Mundo Real: Versionamento de Documentos
    /// </summary>
    public class Versao
    {
        #region Atributos
        ...
        [FichaIndividual(
            ...
            "Identificar a versão do documento e estabelecer a relação entre as versões	anteriores e posteriores.",
            ...
            "Registrar	informações	relativas	a:	identificador	da	versão,	descrição	de	alterações,	data/ " +
            "hora da produção da versão e da transmissão, e o relacionamento entre as versões." +
            "É recomendável que seja gerado automaticamente pelo SIGAD. " +
            "Versões de documentos podem integrar processos e / ou dossiês.",
            null,
            "2.2.2 / 3.1.5 / 3.1.18")]
        public long? VersaoId { get; private set; }
        public String DescricaoDaAlteracao { get; private set; }
        public DateTime DataDaProducao { get; private set; }
        public DateTime DataDaTransmissao { get; private set; }

        public DocumentoArquivistico DocumentoArquivistico { get; private set; }
        #endregion
